...
`;
	...
	const navBarFunc = (data) => (
		<div className={(navBarState ? "bg-none " : "bg-mdd-purple-dark pl-4 main-bg-gradient-inverted ") + "absolute h-full pr-4 pt-4 space-y-4 right-0 z-50 md:bg-opacity-0 md:static md:flex md:flex-row md:space-x-4 md:items-center md:justify-end md:mr-6 md:mt-3"}>
			...
			<div className={(navBarState ? "hidden " : "block ") + "md:flex md:flex-row md:space-x-4 md:items-center md:justify-end navMenu space-y-2 pt-4 md:space-y-0 md:pt-0"}>
